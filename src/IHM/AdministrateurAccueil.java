 ...
 * @author Abdelkrim
 */
public class AdministrateurAccueil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        NpLabel1.setText("Administrateur: ");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imgs/admin logo 2.png"))); // NOI18N
        jLabel1.setText("    ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministrateurAccueil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdministrateurAccueil().setVisible(true);
            }
        });
    }
