 ...
 * @author hatim
 */
public class OperationModelAffichagePatient extends AbstractTableModel {
  private int NbLignes=0;
  private int NbCol=0;
  private String[] Titres;
  private ArrayList<Vector<String>> MesLignes = new ArrayList<Vector<String>>();
  
  public OperationModelAffichagePatient()
  {
      
  }
  public OperationModelAffichagePatient(ResultSet Rs)
  {
   try{
       ResultSetMetaData rsmd = Rs.getMetaData();
       NbCol = rsmd.getColumnCount();
       Titres = new String[NbCol];
       Titres[0]="TYPE OPERATION";
       Titres[1]="DATE";
       Titres[2]="REMARQUES";
